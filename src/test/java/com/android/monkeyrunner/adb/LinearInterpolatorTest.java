...
public class LinearInterpolatorTest extends TestCase {
    ...
    public void testLerpRight() {
        ...
        lerp.interpolate(new Point(0, 100),
                new Point(1000, 100),
                collector);

        List<Point> points = collector.getPoints();
    ...
    public void testLerpLeft() {
        LinearInterpolator lerp = new LinearInterpolator(10);
        Collector collector = new Collector();
        lerp.interpolate(new Point(1000, 100),
                new Point(0, 100),
                collector);
    ...
    public void testLerpUp() {
        LinearInterpolator lerp = new LinearInterpolator(10);
        Collector collector = new Collector();
        lerp.interpolate(new Point(100, 1000),
                new Point(100, 0),
                collector);
    ...
    public void testLerpDown() {
        LinearInterpolator lerp = new LinearInterpolator(10);
        Collector collector = new Collector();
        lerp.interpolate(new Point(100, 0),
                new Point(100, 1000),
                collector);
    ...
    public void testLerpNW() {
        LinearInterpolator lerp = new LinearInterpolator(10);
        Collector collector = new Collector();
        lerp.interpolate(new Point(0, 0),
                new Point(1000, 1000),
                collector);
    ...
    public void testLerpNE() {
        LinearInterpolator lerp = new LinearInterpolator(10);
        Collector collector = new Collector();
        lerp.interpolate(new Point(1000, 1000),
                new Point(0, 0),
                collector);
