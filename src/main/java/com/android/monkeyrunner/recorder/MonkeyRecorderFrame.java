...
public class MonkeyRecorderFrame extends JFrame {
        ...
        if (flingButton == null) {
            ...
            flingButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    JComboBox directionChooser = new JComboBox(Direction.getNames());
                    ...
                    if (result == JOptionPane.OK_OPTION) {
                        Direction dir =
                            Direction.valueOf((String) directionChooser.getSelectedItem());
    ...
    private JButton getExportActionButton() {
        if (exportActionButton == null) {
            ...
            exportActionButton.addActionListener(new ActionListener() {
